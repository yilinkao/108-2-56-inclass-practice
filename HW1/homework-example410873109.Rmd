...
two_times<-
  list(
   taiwan_time=c(
     'Date/Time'=ymd_hms("西元2019年4月12日 12點55分30秒")
   ),
   oslo_time=c(
     'Date/Time'=ymd_hms("18.11.2018 15:33:02")
   )
  )
str(two_times)
```
...
```{r}
fromJSON("https://data.ntpc.gov.tw/api/v1/rest/datastore/382000000A-000328-002",simplifyDataFrame = F)->accidents
print(accidents)
length(accidents)
str(accidents$result$fields)
#str(accidents)
```
...
accidents<-list(
  ...
  bureaus=list(
    `板橋分局`=list(
    type=c("field1=0,field2=0,field3=0,field4=0,field5=0,field6=0,field7=0,field8=0,field9=0,field10=0,field11=0,field12=0,field13=1,field14=0,field15=0,field16=0,other=0"),
    casualties=1),
    `海山分局`=list(
      type=c("field1=0,field2=0,field3=0,field4=0,field5=0,field6=0,field7=0,field8=0,field9=0,field10=0,field11=0,field12=1,field13=0,field14=0,field15=0,field16=0,other=0"),
      casualties=1)
)
)
str(accidents)
...
```
.randomReceipts <- function(n=200){
  factor(
    c(sample(1:10, n-3, replace=T),1,1,1),
    levels=c(5,3,2,1,4,6,7,8,9,10)
  )
}

.randomFiveReceipts <- function(){
  factor(
    c(sample(1:5, 3, replace=T),1,1),
    levels=c(5,3,2,1,4)
  ) -> fiveReceipts
  return(fiveReceipts)
}
